...
_G.packer_plugins = {
  ...
  ["nvim-treesitter-context"] = {
    loaded = true,
    path = "/home/oliver/.local/share/nvim/site/pack/packer/start/nvim-treesitter-context",
  ...
  playground = {
    loaded = true,
    path = "/home/oliver/.local/share/nvim/site/pack/packer/start/playground",
  ...
  ["tokyonight.nvim"] = {
    loaded = true,
    path = "/home/oliver/.local/share/nvim/site/pack/packer/start/tokyonight.nvim",
